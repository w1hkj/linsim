...
/** \mainpage LinSim Sourcecode Interactive Doxygen Documentation : 000GIT_REVISION000
 <div align="center"><img src="fldigi-psk.png" ></div>

 \section intro Introduction

  Welcome to the LinSim Interactive Doxygen Sourcecode Documentation!
  Here you'll find information useful for developing and debugging LinSim. 
  
  LinSim - Simulate ionospheric radio paths, including multiple paths and layers.


  <BR>
  \section download To Download LinSim :
  <UL>
  <LI> To pull latest source with developer access: <B> git clone ssh://<YOUR-LOGIN>\@git.code.sf.net/p/fldigi/linsim fldigi-linsim</B></LI>
  <LI> To pull latest source with developer access behind proxy/firewall: <B> git clone https://<YOUR-LOGIN>\@git.code.sf.net/p/fldigi/linsim fldigi-linsim</B></LI>
  <LI> To pull latest source with no account, read-only: <B> git clone git://git.code.sf.net/p/fldigi/linsim fldigi-linsim</B></LI>
  </UL>
  ...
  <OL>
  <LI>Download the LinSim sourcecode as described above</LI>
